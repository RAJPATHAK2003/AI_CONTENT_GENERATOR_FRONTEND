...
import { handleFreeSubscriptionAPI } from "../../apis/stripePayments/stripePayment";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        {mutation?.isLoading && <StatusMessage type='loading' message="loading..."/>}
        ...
        <button onClick={handConfirmClick} className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
